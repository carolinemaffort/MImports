...
<div class="row">
        ...
        try {
              ...
              foreach ($result as $rere) {
                ...
                <br>- Foto: <img src='https://hostdeprojetosdoifsp.gru.br/mimports/assets/images/" . $rere["foto"] . "' alt='' width='300'><br><br><input type='file' name='foto' value='" . $rere["foto"] . "'><br><br>
